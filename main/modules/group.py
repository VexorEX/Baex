...
async def register_group_handlers(client, session_name, owner_id):
    ...
    async def handle_lock_chat_photo_on(event):
        try:
            ...
            await update_settings(db, settings)
            await send_message(
                event, get_message("lock_photo_enabled"), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_lock_chat_photo_off(event):
        try:
            ...
            await update_settings(db, settings)
            await send_message(
                event, get_message("lock_photo_disabled"), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_photo_change(event):
        try:
            if (
                settings["group_settings"]["lock_photo"]
                and event.photo_changed
                and event.user_id != owner_id
            ):
                # فرض: بازگرداندن عکس قبلی امکان‌پذیر نیست، بنابراین اطلاع‌رسانی می‌کنیم
                await send_message(
                    event, get_message("photo_change_restricted"), parse_mode="html"
                )
        except Exception as e:
    ...
    async def handle_lock_title_on(event):
        try:
            ...
            settings["group_settings"]["locked_title"] = (
                await client.get_entity(event.chat_id)
            ).title
            await update_settings(db, settings)
            await send_message(
                event, get_message("lock_title_enabled"), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_lock_title_off(event):
        try:
            ...
            await update_settings(db, settings)
            await send_message(
                event, get_message("lock_title_disabled"), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_title_change(event):
        try:
            if (
                settings["group_settings"]["lock_title"]
                and event.title_changed
                and event.user_id != owner_id
            ):
                await client(
                    EditTitleRequest(
                        event.chat_id, settings["group_settings"]["locked_title"]
                    )
                )
                await send_message(
                    event, get_message("title_reverted"), parse_mode="html"
                )
        except Exception as e:
    ...
    async def handle_auto_leave_on(event):
        try:
            ...
            await update_settings(db, settings)
            await send_message(
                event, get_message("auto_leave_enabled"), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_auto_leave_off(event):
        try:
            ...
            await update_settings(db, settings)
            await send_message(
                event, get_message("auto_leave_disabled"), parse_mode="html"
            )
        except Exception as e:
                ...
                if settings["group_settings"]["join_mode_type"] == "ban":
                    await client(
                        EditBannedRequest(
                            event.chat_id,
                            event.user_id,
                            banned_rights=ChannelParticipantBanned(until_date=None),
                        )
                    )
                    await send_message(
                        event,
                        get_message("new_member_banned", user_id=event.user_id),
                        parse_mode="html",
                    )
                    ...
                    await client(
                        EditBannedRequest(
                            event.chat_id,
                            event.user_id,
                            banned_rights=ChannelParticipantBanned(
                    ...
                    await send_message(
                        event,
                        get_message("new_member_muted", user_id=event.user_id),
                        parse_mode="html",
                    )
            if event.user_added:
                settings["group_settings"]["join_time"][event.user_id] = datetime.now(
                    pytz.UTC
                ).timestamp()
                await update_settings(db, settings)
        except Exception as e:
    ...
    async def handle_silence_off(event):
        try:
            ...
            await update_settings(db, settings)
            await send_message(
                event, get_message("silence_disabled"), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_silence_messages(event):
        try:
            ...
            if (
                settings["group_settings"]["silence_mode"]
                ...
                if (
                    ...
                    > settings["group_settings"]["silence_duration"]
                ):
                ...
                settings["group_settings"]["ban_all_enabled"]
                and event.sender_id in settings["group_settings"]["ban_all_list"]
            ):
                try:
                    await client(
                        EditBannedRequest(
    ...
    async def handle_silence_all(event):
        try:
            if event.sender_id != owner_id:
                ...
                return
            duration = (
                int(event.pattern_match.group(1)) if event.pattern_match.group(1) else 0
            )
            settings["group_settings"]["silence_all"] = True
            settings["group_settings"]["silence_duration"] = (
                datetime.now(pytz.UTC).timestamp() + duration
            )
            await update_settings(db, settings)
            await send_message(
                event,
                get_message("silence_all_enabled", duration=duration),
                parse_mode="html",
            )
        except Exception as e:
    ...
    async def handle_cancel_silence_all(event):
        try:
            ...
            await update_settings(db, settings)
            await send_message(
                event, get_message("silence_all_disabled"), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_tag_members(event):
        try:
            ...
            await send_message(
                event,
                get_message("members_tagged", count=len(members)),
                parse_mode="html",
            )
        except Exception as e:
    ...
    async def handle_tag_admins(event):
        try:
            ...
            await send_message(
                event,
                get_message("admins_tagged", count=len(admins)),
                parse_mode="html",
            )
        except Exception as e:
    ...
    async def handle_tag_bots(event):
        try:
            ...
            for i in range(0, len(bots), chunk_size):
                ...
                await asyncio.sleep(1)
            await send_message(
                event, get_message("bots_tagged", count=len(bots)), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_invite(event):
        try:
            ...
            if event.is_reply:
                ...
                await send_message(
                    event,
                    get_message("user_invited", user=user.first_name),
                    parse_mode="html",
                )
            else:
            ...
            await send_message(
                event, get_message("user_privacy_restricted"), parse_mode="html"
            )
        except Exception as e:
        ...
        try:
            ...
            for bot_username in bot_list:
                try:
                    ...
                    continue
            await send_message(
                event, get_message("bots_added", count=added_count), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_pin_message(event):
        try:
            ...
            if event.is_reply:
                ...
                await send_message(
                    event, get_message("message_pinned"), parse_mode="html"
                )
            else:
    ...
    async def handle_unpin_message(event):
        try:
            ...
            if event.is_reply:
                ...
                await send_message(
                    event, get_message("message_unpinned"), parse_mode="html"
                )
            else:
                await send_message(event, get_message("reply_to_message"))
        except Exception as e:
    ...
    async def handle_repin_message(event):
        try:
            ...
            if event.is_reply:
                ...
                await send_message(
                    event, get_message("message_repinned"), parse_mode="html"
                )
            else:
                await send_message(event, get_message("reply_to_message"))
        except Exception as e:
    ...
    async def handle_unpin_all(event):
        try:
            ...
            await send_message(
                event, get_message("all_pins_unpinned"), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_group_info(event):
        try:
            ...
            await send_message(
                event, get_message("group_info", info=info), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_group_id(event):
        try:
            if event.sender_id != owner_id:
                ...
                return
            await send_message(
                event, get_message("group_id", id=event.chat_id), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_group_link(event):
        try:
            ...
            await send_message(
                event, get_message("group_link", link=link), parse_mode="html"
            )
        except Exception as e:
        ...
        try:
            ...
            if event.is_reply:
                ...
                await send_message(
                    event,
                    get_message(
                        "nickname_set", user=user.first_name, nickname=nickname
                    ),
                    parse_mode="html",
                )
            else:
    ...
    async def handle_leave_all_groups(event):
        try:
            ...
            await send_message(
                event,
                get_message("left_all_groups", count=left_count),
                parse_mode="html",
            )
        except Exception as e:
    ...
    async def handle_get_join_time(event):
        try:
            ...
            if event.is_reply:
                ...
                if join_time != "N/A":
                    join_time = datetime.fromtimestamp(join_time, tz=pytz.UTC).strftime(
                        "%Y/%m/%d %H:%M:%S"
                    )
                await send_message(
                    event,
                    get_message("join_time", user=user.first_name, time=join_time),
                    parse_mode="html",
                )
            else:
                await send_message(event, get_message("reply_to_user"))
    ...
    async def handle_group_typing_on(event):
        try:
            ...
            await update_settings(db, settings)
            await send_message(
                event, get_message("group_typing_enabled"), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_group_typing_off(event):
        try:
            ...
            await update_settings(db, settings)
            await send_message(
                event, get_message("group_typing_disabled"), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_create_group(event):
        try:
            ...
            if not title:
                await send_message(
                    event, get_message("missing_group_title"), parse_mode="html"
                )
                return
            group_id = (
                await client(
            ...
            await send_message(
                event,
                get_message("group_created", title=title, id=group_id),
                parse_mode="html",
            )
        except UsernameOccupiedError:
            await send_message(
                event, get_message("group_title_taken"), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_cleanup_messages(event):
        try:
            ...
            await send_message(
                event,
                get_message("messages_cleaned", count=len(message_ids)),
                parse_mode="html",
            )
        except Exception as e:
    ...
    async def handle_cleanup_gifs(event):
        try:
            ...
            await send_message(
                event,
                get_message("gifs_cleaned", count=len(message_ids)),
                parse_mode="html",
            )
        except Exception as e:
    ...
    async def handle_cleanup_photos(event):
        try:
            ...
            await send_message(
                event,
                get_message("photos_cleaned", count=len(message_ids)),
                parse_mode="html",
            )
        except Exception as e:
    ...
    async def handle_cleanup_videos(event):
        try:
            ...
            await send_message(
                event,
                get_message("videos_cleaned", count=len(message_ids)),
                parse_mode="html",
            )
        except Exception as e:
    ...
    async def handle_cleanup_audios(event):
        try:
            ...
            await send_message(
                event,
                get_message("audios_cleaned", count=len(message_ids)),
                parse_mode="html",
            )
        except Exception as e:
    ...
    async def handle_cleanup_voices(event):
        try:
            ...
            await send_message(
                event,
                get_message("voices_cleaned", count=len(message_ids)),
                parse_mode="html",
            )
        except Exception as e:
        ...
        try:
            ...
            if event.is_reply:
                ...
                async for message in client.iter_messages(
                    event.chat_id, from_user=user.id, limit=100
                ):
                    message_ids.append(message.id)
                await client.delete_messages(event.chat_id, message_ids)
                await send_message(
    ...
    async def handle_cleanup_block_list(event):
        try:
            ...
            await update_settings(db, settings)
            await send_message(
                event, get_message("block_list_cleaned"), parse_mode="html"
            )
        except Exception as e:
    ...
    pattern = (
        commands.get(lang, {}).get("group", {}).get("cleanup_deleted_accounts", "")
    )
    ...
    async def handle_cleanup_deleted_accounts(event):
        try:
            ...
            await send_message(
                event,
                get_message("deleted_accounts_cleaned", count=deleted_count),
                parse_mode="html",
            )
        except Exception as e:
    ...
    async def handle_cleanup_bots(event):
        try:
            ...
            async for user in client.iter_participants(
                ...
                await asyncio.sleep(1)
            await send_message(
                event, get_message("bots_cleaned", count=bot_count), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_cleanup_members(event):
        try:
            ...
            member_count = 0
            async for user in client.iter_participants(
                event.chat_id, filter=ChannelParticipantsRecent
            ):
                if user.id != owner_id:
                    await client(
                        EditBannedRequest(
            ...
            await send_message(
                event,
                get_message("members_cleaned", count=member_count),
                parse_mode="html",
            )
        except Exception as e:
    ...
    async def handle_cleanup_between(event):
        try:
            ...
            await send_message(
                event,
                get_message("messages_cleaned_between", count=len(message_ids)),
                parse_mode="html",
            )
        except Exception as e:
    ...
    async def handle_join_mode_on(event):
        try:
            ...
            await update_settings(db, settings)
            await send_message(
                event, get_message("join_mode_enabled"), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_join_mode_off(event):
        try:
            ...
            await update_settings(db, settings)
            await send_message(
                event, get_message("join_mode_disabled"), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_join_mode_ban(event):
        try:
            ...
            await update_settings(db, settings)
            await send_message(
                event, get_message("join_mode_ban_set"), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_join_mode_mute(event):
        try:
            ...
            await update_settings(db, settings)
            await send_message(
                event, get_message("join_mode_mute_set"), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_filter_add(event):
        try:
            ...
            await update_settings(db, settings)
            await send_message(
                event, get_message("filter_added", count=len(words)), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_filter_remove(event):
        try:
            ...
            if word in settings["group_settings"]["filter_list"]:
                ...
                await update_settings(db, settings)
                await send_message(
                    event, get_message("filter_removed", word=word), parse_mode="html"
                )
            else:
                await send_message(
                    event, get_message("filter_not_found"), parse_mode="html"
                )
        except Exception as e:
    ...
    async def handle_filter_list(event):
        try:
            ...
            if filters:
                filter_text = "\n".join(
                    [f"{i + 1}. {f}" for i, f in enumerate(filters)]
                )
                await send_message(
                    event,
                    get_message("filter_list", filters=filter_text),
                    parse_mode="html",
                )
            else:
    ...
    async def handle_filter_clear(event):
        try:
            ...
            await update_settings(db, settings)
            await send_message(
                event, get_message("filter_list_cleared"), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_sallow(event):
        try:
            ...
            await update_settings(db, settings)
            await send_message(
                event, get_message("allow_added", count=len(words)), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_sdelallow(event):
        try:
            ...
            if word in settings["group_settings"]["allow_list"]:
                ...
                await update_settings(db, settings)
                await send_message(
                    event, get_message("allow_removed", word=word), parse_mode="html"
                )
            else:
                await send_message(
                    event, get_message("allow_not_found"), parse_mode="html"
                )
        except Exception as e:
    ...
    async def handle_sallowlist(event):
        try:
            ...
            if allows:
                ...
                await send_message(
                    event,
                    get_message("allow_list", allows=allow_text),
                    parse_mode="html",
                )
            else:
    ...
    async def handle_clean_sallowlist(event):
        try:
            ...
            await update_settings(db, settings)
            await send_message(
                event, get_message("allow_list_cleared"), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_set_slow_mode(event):
        try:
            ...
            await send_message(
                event,
                get_message("slow_mode_set", duration=duration),
                parse_mode="html",
            )
        except Exception as e:
    ...
    async def handle_remove_slow_mode(event):
        try:
            ...
            await update_settings(db, settings)
            await send_message(
                event, get_message("slow_mode_removed"), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_kick(event):
        try:
            ...
            if event.is_reply:
                ...
                await send_message(
                    event,
                    get_message("user_kicked", user=user.first_name),
                    parse_mode="html",
                )
            else:
    ...
    async def handle_unban(event):
        try:
            ...
            if event.is_reply:
                ...
                user = await client.get_entity(reply_msg.sender_id)
                await client(
                    EditBannedRequest(event.chat_id, user.id, banned_rights=None)
                )
                await send_message(
                    event,
                    get_message("user_unbanned", user=user.first_name),
                    parse_mode="html",
                )
            else:
    ...
    async def handle_mute(event):
        try:
            ...
            if event.is_reply:
                ...
                await send_message(
                    event,
                    get_message("user_muted", user=user.first_name),
                    parse_mode="html",
                )
            else:
                await send_message(event, get_message("reply_to_user"))
        ...
        try:
            ...
            if event.is_reply:
                ...
                if user.id in settings["group_settings"]["mute_list"]:
                    ...
                    await send_message(
                        event,
                        get_message("user_unmuted", user=user.first_name),
                        parse_mode="html",
                    )
                else:
                    await send_message(
                        event, get_message("user_not_muted"), parse_mode="html"
                    )
            else:
                await send_message(event, get_message("reply_to_user"))
        except Exception as e:
    ...
    async def handle_mute_list(event):
        try:
            ...
            if mute_list:
                ...
                await send_message(
                    event, get_message("mute_list", list=mute_text), parse_mode="html"
                )
            else:
                await send_message(
                    event, get_message("no_muted_users"), parse_mode="html"
                )
        except Exception as e:
    ...
    async def handle_clear_mute_list(event):
        try:
            ...
            await update_settings(db, settings)
            await send_message(
                event, get_message("mute_list_cleared"), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_welcome_off(event):
        try:
            ...
            await update_settings(db, settings)
            await send_message(
                event, get_message("welcome_disabled"), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_set_welcome(event):
        try:
            ...
            if event.is_reply:
                ...
                await update_settings(db, settings)
                await send_message(
                    event, get_message("welcome_message_set"), parse_mode="html"
                )
            else:
                await send_message(event, get_message("reply_to_message"))
        except Exception as e:
            ...
            if event.is_reply:
                ...
                async for dialog in client.iter_dialogs():
                    if dialog.is_group or (
                        dialog.is_channel and dialog.entity.megagroup
                    ):
                        try:
                            await client(
                                EditBannedRequest(
                            ...
                            await client.delete_messages(
                                ...
                                [
                                    ...
                                    async for m in client.iter_messages(
                                        dialog.entity.id, from_user=user.id, limit=10
                                    )
                                ],
                            )
                        await asyncio.sleep(1)
                await send_message(
                    event,
                    get_message("user_banned_all", user=user.first_name),
                    parse_mode="html",
                )
            else:
                await send_message(event, get_message("reply_to_user"))
                ...
                if user.id in settings["group_settings"]["ban_all_list"]:
                    ...
                    async for dialog in client.iter_dialogs():
                        if dialog.is_group or (
                            ...
                            await client(
                                EditBannedRequest(
                                    dialog.entity.id, user.id, banned_rights=None
                                )
                            )
                            await asyncio.sleep(1)
                    await send_message(
                        event,
                        get_message("user_unbanned_all", user=user.first_name),
                        parse_mode="html",
                    )
                else:
                    await send_message(
                        event, get_message("user_not_banned_all"), parse_mode="html"
                    )
            else:
                await send_message(event, get_message("reply_to_user"))
        except Exception as e:
    ...
    async def handle_ban_all_list(event):
        try:
            ...
            if ban_list:
                ...
                await send_message(
                    event, get_message("ban_all_list", list=ban_text), parse_mode="html"
                )
            else:
                await send_message(
                    event, get_message("no_banned_users"), parse_mode="html"
                )
        except Exception as e:
    ...
    async def handle_clear_ban_all_list(event):
        try:
            ...
            await update_settings(db, settings)
            await send_message(
                event, get_message("ban_all_list_cleared"), parse_mode="html"
            )
        except Exception as e:
    ...
    async def handle_invite_voice_chat(event):
        try:
            ...
            for username in usernames:
                try:
                    ...
                    await client.send_message(
                        ...
                        get_message(
                            "voice_chat_invite",
                            group=(await client.get_entity(event.chat_id)).title,
                        ),
                        parse_mode="html",
                    )
                    invited_count += 1
            ...
            await send_message(
                event,
                get_message("voice_chat_invited", count=invited_count),
                parse_mode="html",
            )
        except Exception as e:
    ...
    async def handle_invite_all_voice_chat(event):
        try:
            ...
            await send_message(
                event,
                get_message("voice_chat_all_invited", count=invited_count),
                parse_mode="html",
            )
        except Exception as e:
